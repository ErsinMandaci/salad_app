...
import '../../../core/widgets/subt_text_content.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                        ...
                        child: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () {
                                ref
                                    .watch(fruitProvider.notifier)
                                    .addBasket(saladWatch?[index]);
                              },
                              icon: const Icon(
                      ...
                      trailing: TextWidget(
                        itemValue:
                            '${ref.watch(fruitProvider.notifier).totalPrice} TL',
                        color: ColorConstansts.iconColor,
                        fontSize: 24,
                      ),
                    ),
