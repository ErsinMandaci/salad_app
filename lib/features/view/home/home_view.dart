...
import 'package:fruit_app/features/view/basket/basket_view.dart';
import 'package:fruit_app/features/riverpod/fruit_provider.dart';
import 'package:fruit_app/features/view/order/order_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ref.watch(fruitProvider).isLoading ?? true
          ? const Center(
              child:
                  CircularProgressIndicator(color: ColorConstansts.iconColor),
            )
        ...
        text: TextSpan(
          ...
          children: [
            TextSpan(
              ...
              style: const TextStyle(
                  color: ColorConstansts.textContentColor, fontSize: 17),
            ),
            const TextSpan(
