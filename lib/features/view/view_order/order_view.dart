...
final class OrderView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: basketList == null || basketList.isEmpty
          ? const Center(
              child: TextWidget(color: ColorConstansts.iconColor, itemValue: 'Henüz ürün eklemediniz'),
            )
          : Column(
                        ...
                        child: Card(
                          ...
                          child: SizedBox(
                            ...
                            child: ListTile(
                              ...
                              leading: Image.network(basketList[index].imageUrl ?? 'Not image'),
                              title: TextWidget(
                                fontSize: 16,
                              ...
                              trailing: TextWidget(
                                fontSize: 16,
                                itemValue: ref.read(fruitProvider.notifier).totalPrice.toString(),
                                color: ColorConstansts.textContentColor,
                              ),
                            ),
                          ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        children: [
                          const SubTextWidget(itemValue: 'Total', color: Colors.black),
                          TextWidget(
                              itemValue: ref.read(fruitProvider.notifier).orderTotolPrice(),
                              color: ColorConstansts.textContentColor),
                        ],
                      ),
                      ElevatedButton(
