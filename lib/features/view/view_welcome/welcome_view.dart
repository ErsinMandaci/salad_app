...
import 'package:fruit_app/features/view/view_auth/auth_view.dart';
...
class _SubText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: const SubTextWidget(itemValue: StringConstants.welcomeSubText, color: ColorConstansts.subTextContentColor),
    );
  }
}
...
class _TextWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: const TextWidget(itemValue: StringConstants.welcomeText, color: ColorConstansts.textContentColor),
    );
  }
}
